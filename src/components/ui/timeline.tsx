    ...
    >
      <div className="max-w-7xl mx-auto py-12 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-lg max-w-2xl">
          A timeline of my professional experience in the tech industry, focusing on growth and impact.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-4xl font-bold text-neutral-500 dark:text-neutral-400 ">
                {item.title}
              </h3>
            </div>
